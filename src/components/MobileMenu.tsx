...
import { Menu, X, Home, Sparkles, BookOpen, GraduationCap, User } from "lucide-react";
              ...
              {navigationItems.map((item) => {
                ...
                return (
                  ...
                  >
                    ...
                    {isActive && <div className="ml-auto h-2 w-2 bg-blue-400 rounded-full animate-pulse"></div>}
                  </a>
                );
              })}
            </nav>
